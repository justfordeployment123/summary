...
const steps = [
    {
        ...
        desc: "Select from Legal, Medical, Government, Financial and more — our AI tailors its analysis to your category.",
    ...
    },
    {
        ...
        desc: "Our AI reads every word and gives you a plain-English summary in seconds, plus an urgency rating.",
        icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
    },
    {
        n: "04",
        title: "Unlock Full Breakdown",
        desc: "Optional paid upgrade gives you a section-by-section analysis with actions, deadlines, and downloadable reports.",
