    ...
    return (
        <div style={{ minHeight: "70vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 24px" }}>
            <div style={{ maxWidth: 500, width: "100%", textAlign: "center", fontFamily: "Raleway, sans-serif" }}>
                ...
                <p style={{ fontSize: "1.1rem", color: "#64748b", lineHeight: 1.6, marginBottom: 32, fontWeight: 500 }}>{pollStatus}</p>
                <div style={{ width: "100%", height: 6, background: "#f1f5f9", borderRadius: 10, overflow: "hidden", marginBottom: 16 }}>
                    <div
                        className="progress-fill"
                        style={{ width: "65%", height: "100%", background: "linear-gradient(90deg, #12A1A6, #54D6D4)", borderRadius: 10 }}
                    />
                </div>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <span style={{ marginLeft: "auto", fontSize: "0.75rem", color: "#94a3b8", fontFamily: "monospace" }}>
                    ID: {completedData.referenceId}
                </span>
            </div>
            ...
            <div style={{ borderLeft: "8px solid #08121f", paddingLeft: 40, marginBottom: 64 }}>
                ...
                <p style={{ fontSize: "1.2rem", color: "#334155", fontWeight: 500, maxWidth: 650, lineHeight: 1.7 }}>
                    Hello, here is the plain English breakdown of your document. We’ve highlighted the most critical points and necessary next steps
                    below.
                </p>
                <div
                    style={{
